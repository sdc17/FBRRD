...
const char CACHE_CPU = 'c';
const char CACHE_GPU = 'g';
...
public:
    ...
    /** GRRIP **/
    double SIGMA_1 = 0.6526;
    double SIGMA_2 = 0.9544;
    double SIGMA_3 = 0.9974;
    ...
    /* FBR */
    _u32 FBR_new_size = 8;
    _u32 FBR_old_size = 16;
    double EPSILON_FBR =  1.0 / 32;
    double FBR_DECAY = 0.002;
    double FRB_LAST = 0.01;
    ...
    /** 最大最小值 **/
    _u32 min_32(_u32 a, _u32 b);
    _u32 max_32(_u32 a, _u32 b);
};
